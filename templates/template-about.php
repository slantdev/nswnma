  ...
  <div class="container py-20">
    <div class="flex flex-col lg:flex-row lg:flex-nowrap">
      <div class="w-full lg:w-7/12">
        <h2 class="h3 text-brand-bluedark font-medium mb-8 mt-8">About the NSWNMA</h2>
    ...
    <div class="flex flex-col lg:flex-row">
      <div class="w-full lg:w-1/2">
        <div class="py-8 lg:pr-16 lg:py-20">
          <h2 class="h3 text-brand-bluedark mb-8 mt-8">Why join NSWNMA?</h2>
          <div class="prose">
...
<section class="bg-brand-grayblue relative">
    ...
    <div class="flex flex-col lg:flex-row lg:justify-end">
      <div class="w-full lg:w-1/2">
        <div class="py-8 lg:pl-16 lg:py-20">
          <h2 class="h3 text-brand-bluedark mb-8 mt-8">Become a member</h2>
          <div class="prose">
            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
          </div>
          <div class="mt-8">
  ...
  <div class="absolute top-0 right-1/2 bottom-0 left-0 h-full">
    <img src="<?php echo nswnma_asset('images/banner/page-banner-2.jpg') ?>" alt="" class="object-cover h-full w-full">
  </div>
</section>
