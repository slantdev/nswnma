...
function nswnma_enqueue_scripts()
{
  ...
  wp_enqueue_script('headroom', 'https://cdnjs.cloudflare.com/ajax/libs/headroom/0.12.0/headroom.min.js', array('jquery'), '0.12.0');
  wp_enqueue_script('headroom-jquery', 'https://cdnjs.cloudflare.com/ajax/libs/headroom/0.12.0/jQuery.headroom.min.js', array('jquery'), '0.12.0');

  wp_enqueue_style('nswnma', nswnma_asset('css/app.css'), array(), $theme->get('Version'));
  wp_enqueue_script('nswnma', nswnma_asset('js/app.js'), array('jquery', 'headroom'), $theme->get('Version'));
}
