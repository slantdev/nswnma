  ...
  <div class="relative bg-cover bg-no-repeat bg-[#5E7FB1]">
    <div class="container mx-auto h-full relative z-10 py-8 lg:py-10 lg:pt-12 lg:pb-8 xl:pt-28 xl:pb-20">
      <div class="md:w-3/4 lg:w-3/5 text-white">
        ...
        ?>
        <div class="text-base md:text-lg mt-6 lg:mt-12"><time datetime="<?php echo get_the_date('c'); ?>" itemprop="datePublished" class="text-lg inline-block pt-3 border-t border-white">Posted on <?php echo get_the_date(); ?></time></div>
      </div>
    </div>
  </div>
</section>
